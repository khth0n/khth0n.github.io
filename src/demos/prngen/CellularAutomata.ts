...
export abstract class CAFramework {
    ...
    constructor( init_state: Dictionary ) {

        this.init_state = init_state;
    }

    seed( init_state: Dictionary ) {
...
export type WolframCAData = {
 ...
 export class WolframCA extends CAFramework {
    ...
    step( step_count: number = 1 ) {
        ...
        this.init_state['timestep']++;

        let { timestep, depth, width, strips } = this.init_state;
        ...
        //console.log( this.init_state['strips']);
    ...
    print_state() {
        ...
        const { timestep, depth, width, strips } = this.init_state;
